               ...
               // System.out.println("\t 3 - Truck");
                ...
                switch (selectedVehicletype) {
                    ...
                    case 2:
                        ...
                        System.out.println("\n\t# # # # Add a truck to the park # # # # ");

                        //getting the id plate of the car
                        System.out.println("\nPlease enter the ID Plate number of the Truck");
                        truck.setIdPlate(sc.next());

                        //getting the brand of the car
                        System.out.println("Please enter the Brand of the Truck");
                        truck.setVehicleBrand(sc.next());
                        ...
                        //getting the number of doors
                        System.out.println("Please enter the number of Doors of the Truck");
                        truck.setNumDoors(sc.nextInt());

                        //getting the color of the car
                        System.out.println("Please enter the Color of the Truck");
                        truck.setCarColor(sc.next());

                        //set the datetime object to the car
                        truck.setDateTime(dateTime);
        ...
        if (totalVehicles == 0) {
            ...
            try {
                ...
                if (leavingVehicle.equals("Car")) {
                    ...
                    parkingSlotCount++;
                    vanCounter--;
              //  } else if (leavingVehicle.equals("Truck")) {
              //      parkingSlotCount++;
               //     bikeCounter--;
                }
